    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true">
        ...
        >
            ...
            <div class="mt-5 space-y-5 text-xs">
                ...
                <div>
                    <p class="block font-bold text-slate-700 dark:text-slate-300 mb-2">再生方式</p>
                        ...
                        {#each protocolOptions as opt}
                            ...
                            >
                                <span class="flex items-center gap-1 text-sm font-black whitespace-nowrap">
                                    ...
                                    {#if opt.badge}
                                        <span
                                            class="rounded px-1.5 py-0.5 text-[10px] font-bold shrink-0 whitespace-nowrap {opt.badge ===
                                            '推奨'
                                                ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300'
                                                : opt.type === 'direct'
