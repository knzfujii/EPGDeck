...
<div class="space-y-5 w-full max-w-full min-w-0">
    <!-- ヘッダー -->
    <div
        class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900"
    >
    ...
    {:else}
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {#each storages as st}
                ...
                <div
                    class="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md dark:border-slate-800 dark:bg-slate-900"
                >
                    <div>
