...
const app = new Hono()
    ...
    .get('/live/:channelId/hls', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
    ...
    .get('/live/:channelId/m2ts/playlist', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const channelId = parseInt(c.req.param('channelId'), 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
    ...
    .get('/live/:channelId/m2ts', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const channelId = parseInt(c.req.param('channelId'), 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
    ...
    .get('/live/:channelId/m2tsll', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const channelId = parseInt(c.req.param('channelId'), 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
    ...
    .get('/live/:channelId/mp4', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const channelId = parseInt(c.req.param('channelId'), 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
    ...
    .get('/live/:channelId/webm', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const channelId = parseInt(c.req.param('channelId'), 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
    ...
    .get('/recorded/:videoFileId/hls', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
    ...
    .get('/recorded/:videoFileId/mp4', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const videoFileId = parseInt(c.req.param('videoFileId'), 10);
        const playPosition = parseInt(c.req.query('ss') || '0', 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
    ...
    .get('/recorded/:videoFileId/webm', async c => {
        const streamApiModel = container.get<IStreamApiModel>('IStreamApiModel');
        const videoFileId = parseInt(c.req.param('videoFileId'), 10);
        const playPosition = parseInt(c.req.query('ss') || '0', 10);
        const mode = parseInt(c.req.query('mode') || '0', 10);
